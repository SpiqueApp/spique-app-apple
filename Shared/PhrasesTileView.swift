...
struct PhrasesTileView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        PhraseTileView(showPhraseDetails: $showPhraseDetails, phrase: Phrase(id: "123", text: "The quick brown fox jumped over the lazy dog.", color: "orange", tags: ["test"], emoji: "💬"))
            .frame(width: 190.0)
    }
}
